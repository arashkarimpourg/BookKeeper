...
public class BookKeeper extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        addUserButton.getStyleClass().add("important-button");
        addUserButton.setOnAction(event -> addUser());

        // Create HBox for Add button
        HBox addUserPane = new HBox();
        addUserPane.getStyleClass().add("button-pane");
        addUserPane.getChildren().add(addUserButton);
        addUserPane.setAlignment(Pos.CENTER_LEFT);
...
//        importFromBookFile(defaultBookFile);
    ...
    private void populateUserEditFields(VBox userEditFieldsPane, UserItem userItem) {
        // Clear the existing content
        userEditFieldsPane.getChildren().clear();

        // Create "Edit user" title
        Label userEditTitle = new Label("Edit user");
        ...
        if (imageStreamUserEdit != null) {
            ...
            System.err.println("Unable to load edit-blue.png");
        }
        ...
        VBox userEditLabelPane = new VBox(userEditLabel, userEditDetailLabel);
        ...
        // Create "Apply" button
        Button userApplyButton = new Button("Apply");
        userApplyButton.getStyleClass().add("important-button");
        userApplyButton.setPrefWidth(90);

        // Create pane for "Cancel" & "Apply" buttons
        HBox userCancelApplyPane = new HBox(userCancelButton, userApplyButton);
        userCancelApplyPane.getStyleClass().add("cancel-apply-spacing");

        // Create row for edit user
        HBox userEditPane = new HBox(userEditIcon, userEditLabelPane, userCancelApplySpacer, userCancelApplyPane);
        ...
        // Create action for "Apply" button
        userApplyButton.setOnAction(event -> {
...
//            populateTableRowBox(bookEditFieldsPane, bookItem);
    ...
    private void addUser() {
        ...
        userEditItem(userItem);
    }

    private void userEditItem(UserItem userItem) {
//        tableView.getSelectionModel().select(userItem);

        toggleUserEditPane(userPane);
        populateUserEditFields(userEditPane, userItem);
    }
